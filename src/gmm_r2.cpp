...
static ros::Publisher pub_n;
  ...
  //constructor looks fine
    ...
    {	image_transport::ImageTransport it(nh_);
    	pMOG2 = createBackgroundSubtractorMOG2();
      	...
      	pub_n = nh_.advertise<std_msgs::Int64MultiArray>("state", 1);//change this to 2 points bas utna kaafi hoga ..uska baad publish only when confidence he high ..like iske saath kf jhod sakte hai aur vo parameter bases pe template nikalna hai *sab kaam til sun
     	ros::Rate loop_rate(10);
      	as_.registerGoalCallback(boost::bind(&Niot_vision::goalCB, this));//goal call back function
  ...
  static int call(const sensor_msgs::ImageConstPtr& msg)
  {
	if (goal_==1)
    {
  ...
  static void processVideo(Mat img) {
